...
append_dropdowns = html.Div([symbol_dropdown, interval_dropdown], className="dropdowns")
...
append_delete = html.Div([append, delete, html.Div(
    id='a_d_out')], className="append-delete")
